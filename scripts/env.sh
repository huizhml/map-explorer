...
export PREDICTIONS_LOCAL_VRT_PATH_TEMPLATE="/projects/dereeco/data/gvs/products/vsm/2020/original/vrt/{tile}_Q{q}.vrt"
...
export PREDICTIONS_MOSAIC_LOCAL_PATH="/projects/dereeco/data/gvs/products/vsm/2020/blended/mosaic/global_mosaic_2020_RH{rh}_Q{q}.cog.tif"
